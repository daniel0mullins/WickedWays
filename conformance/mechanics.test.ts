...
const start = readFileSync(join(here, "fixtures/mechanics.start.snapshot.json"), "utf8");
const catalogJson = readFileSync(join(here, "fixtures/mechanics.catalog.json"), "utf8");
const golden = JSON.parse(
  readFileSync(join(here, "fixtures/mechanics.golden.json"), "utf8"),
) as {
  seed: number;
  commands: unknown[];
...
describe("mechanics differential conformance", () => {
