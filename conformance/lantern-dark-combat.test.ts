...
const start = readFileSync(join(here, "fixtures/lantern-dark-combat.start.snapshot.json"), "utf8");
const catalogJson = readFileSync(join(here, "fixtures/lantern-dark-combat.catalog.json"), "utf8");
const golden = JSON.parse(
  readFileSync(join(here, "fixtures/lantern-dark-combat.golden.json"), "utf8"),
) as {
  seed: number;
  commands: unknown[];
...
describe("lantern-dark-combat differential conformance", () => {
