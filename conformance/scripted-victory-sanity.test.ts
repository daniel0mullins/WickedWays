...
const start = readFileSync(join(here, "fixtures/scripted-victory-sanity.start.snapshot.json"), "utf8");
const catalogJson = readFileSync(join(here, "fixtures/scripted-victory-sanity.catalog.json"), "utf8");
const golden = JSON.parse(
  readFileSync(join(here, "fixtures/scripted-victory-sanity.golden.json"), "utf8"),
) as {
  seed: number;
  commands: unknown[];
...
describe("scripted-victory-sanity differential conformance", () => {
