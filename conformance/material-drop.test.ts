...
const start = readFileSync(join(here, "fixtures/material-drop.start.snapshot.json"), "utf8");
const catalogJson = readFileSync(join(here, "fixtures/material-drop.catalog.json"), "utf8");
const golden = JSON.parse(
  readFileSync(join(here, "fixtures/material-drop.golden.json"), "utf8"),
) as {
  seed: number;
  commands: unknown[];
...
describe("material-drop differential conformance", () => {
