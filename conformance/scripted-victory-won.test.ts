...
const start = readFileSync(join(here, "fixtures/scripted-victory-won.start.snapshot.json"), "utf8");
const catalogJson = readFileSync(join(here, "fixtures/scripted-victory-won.catalog.json"), "utf8");
const golden = JSON.parse(
  readFileSync(join(here, "fixtures/scripted-victory-won.golden.json"), "utf8"),
) as {
  seed: number;
  commands: unknown[];
...
describe("scripted-victory-won differential conformance", () => {
