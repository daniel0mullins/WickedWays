 ...
 */
export type BehaviorScript = { "family": "mechanic", script: MechanicScript, } | { "family": "exit", script: ExitScript, } | { "family": "victory", script: VictoryScript, } | { "family": "item", script: ItemScript, } | { "family": "npc", script: NpcScript, } | { "family": "scene", script: SceneScript, };
